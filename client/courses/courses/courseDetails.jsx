...
function CourseDetails() {
  ...
  const index =currentUser?.courseWishlist?.findIndex(courseObj => courseObj._id.toString() === courseToPreview?._id.toString())
  return (
    <Container className="allcourse" dir={i18n.dir()}>
      ...
      <Row className="justify-content-start">
        <Col lg={6} md={6} sm={12}>
          ...
          <div className="course-details">
            <div className="details">
              <img src={courseToPreview?.image.url} alt="course-logo" />
              <h3>
                {t("Rate.Rate")}{" "}
          ...
          <div className="course-content">
                <h5>{t("courseDetails.duration")}</h5>
                <p>
              ...
              <div className="course-content">
                <h5>{t("courseDetails.level")}</h5>
                <p>{courseToPreview?.level}</p>
              </div>
              <hr />
        ...
        <Col lg={6} md={6} sm={12}>
          <img className="img-course-det" src="../src/images/courses.jpg"/>
          <div className="learn">
            <div className="course-content">
            ...
            <div className="course-content">
              ...
              >
                ...
                {userRate
                  ...
                  : rate && (
                      <span
                        style={{ margin: "0", fontSize: "20px", width: "20%" }}
                      >
